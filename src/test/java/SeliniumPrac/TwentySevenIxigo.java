...
public class TwentySevenIxigo {
	...
	public void f() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='container calendar  ']/div/div[3]")).click();
		//driver.findElement(By.xpath("//input[@placeholder='Onward Journey Date']")).sendKeys("30/11/2023");
		driver.findElement(By.xpath("//div[@class='container calendar  ']/div[2]/span[27]")).click();
		Thread.sleep(2000);
		// search button
